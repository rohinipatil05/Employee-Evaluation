<%@ Page Title="" Language="C#" MasterPageFile="~/Sidebar-Master.Master" AutoEventWireup="true" CodeBehind="Add-Employee.aspx.cs" Inherits="EmployeEvaluation.Add_Employee" %>
        ...
        <table class="auto-style6">
            ...
            <tr>
                ...
                <td class="auto-style3">
                     ...
                     <asp:DropDownList ID="DropDownList4" runat="server" class="form-control form-control-sm" Width="430px" Height="30px">
             ...
             <tr>
                ...
                <td class="auto-style3">
                   ...
                   <asp:Button ID="btnsub" runat="server" class="btn btn-secondary" Text="Submit" Width="90px" OnClick="btnsub_Click"  />               
                    &nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnreset" runat="server" class="btn btn-info" Text="Close" BackColor="#99CCFF" Width="90px"  />
