<%@ Page Language="C#" AutoEventWireup="false"  MasterPageFile="~/Sidebar-Master.Master" CodeBehind="adddepartment.aspx.cs" Inherits="EmployeEvaluation.adddepartment" %>
        ...
        <table class="w-100">
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="nametxt" class="form-control form-control-sm" runat="server" Font-Size="Medium" Width="390px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">
             ...
             <tr>
                ...
                <td class="auto-style3">
                   ...
                   <asp:Button ID="Button1" runat="server" class="btn btn-secondary" Text="Cancel" Width="90px" />               
                    &nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" class="btn btn-info" Text="Add Department" BackColor="#99CCFF" Width="156px" OnClick="Button2_Click" />
