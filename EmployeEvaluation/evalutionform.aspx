<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Sidebar-Master.Master" CodeBehind="evalutionform.aspx.cs" Inherits="EmployeEvaluation.evalutionform" %>
       ...
       <div class="page-content">
        ...
        <table class="w-100">
            ...
            <tr>
             ...
             <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label5" runat="server" Text="Date" Font-Size="Medium"></asp:Label><asp:Label ID="Label7" runat="server" Text="*" ForeColor="Red"></asp:Label>
                </td>
                <td class="auto-style3">
                    &nbsp;</td>
            </tr>
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="auto-style3">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" class="btn btn-info" Text="Submit" BackColor="#99CCFF" Width="90px" />
