<%@ Page Title="" Language="C#" MasterPageFile="~/EvaluatorMaster.Master" AutoEventWireup="true" CodeBehind="Awards-Rewards.aspx.cs" Inherits="EmployeEvaluation.Awards_Rewards" %>
  ...
  <body>
    <div class="page-content">
			...
			<form class="form-detail" action="#" method="post" runat="server">
				...
				<h2 class="auto-style1">Awards/Rewards</h2>
